...
$original_category_id =  decryptdata($category_id);
$flag   		= isset($_GET['flag']) ? $_GET['flag'] : '';
$filename 		= 'addForm.php';
$titlename 		= 'Add Category Basic Info';
?>
<!DOCTYPE html>
...
<head>
   <meta charset="utf-8" />
   <title>T- Category Control Panel |  <?php print $titlename;?> </title>
               ...
               <div class="span12">
                  <div class="tabbable tabbable-custom boxless">
                     <ul class="nav nav-tabs">
                        <li class="<?php if($category_id == '' || $category_id =='0'){ echo 'active'; } ?>"  id="li_pat0"><a data-toggle="tab" href="#tab_1" onClick="change_tab(0);">Category Listing</a></li>
                        <li class="<?php if($category_id > 0){ echo 'active'; } ?>"  id="li_pat1"><a data-toggle="tab" href="#tab_2"  onclick="change_tab(1);">Add/Edit Category</a></li>
                     </ul>
                     <div class="tab-content">
                        <div id="tab_1" class="tab-pane <?php if($category_id == '' || $category_id =='0'){ echo 'active'; } ?>">
                           <?php include_once('listing.php');?>
                        </div>
                        <div id="tab_2" class="tab-pane <?php if($category_id > 0){ echo 'active'; } ?>">
						<?php
							 $category_id   = decryptdata($category_id);
							 include_once($filename);
							 $category_id   = encryptdata($category_id);
						?>
                        </div>
                     </div>
                  </div>
