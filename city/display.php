...
$original_city_id =  decryptdata(city_id);
$flag   		= isset($_GET['flag']) ? $_GET['flag'] : '';
$filename 		= 'addForm.php';
$titlename 		= 'Add City Basic Info';
?>
<!DOCTYPE html>
...
<head>
   <meta charset="utf-8" />
   <title>T- City Control Panel |  <?php print $titlename;?> </title>
               ...
               <div class="span12">
                  <div class="tabbable tabbable-custom boxless">
                     <ul class="nav nav-tabs">
                        <li class="<?php if($city_id == '' || $city_id =='0'){ echo 'active'; } ?>"  id="li_pat0"><a data-toggle="tab" href="#tab_1" onClick="change_tab(0);">City Listing</a></li>
                        <?php if(in_array('add',$actionArr)): ?>
                        <li class="<?php if($city_id > 0){ echo 'active'; } ?>"  id="li_pat1"><a data-toggle="tab" href="#tab_2"  onclick="change_tab(1);">Add/Edit City</a></li>
                        <?php endif; ?>
                      </ul>
                     <div class="tab-content">
                        <div id="tab_1" class="tab-pane <?php if($city_id == '' || $city_id =='0'){ echo 'active'; } ?>">
                           <?php include_once('listing.php');?>
                        </div>
                        <div id="tab_2" class="tab-pane <?php if($city_id > 0){ echo 'active'; } ?>">
						<?php
  							 $city_id   = decryptdata($city_id);
